# O06: Alternative graph database backend

## Objective

Add Neo4j or FalkorDB behind repository ports and benchmark it.

## Context files

- `M16 PostgreSQL baseline`
...
- Compare correctness, p95 latency, operational complexity, and storage.


## Non-goals

- Do not replace the main backend without measured benefit.
