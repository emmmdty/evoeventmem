# O02: Procedural memory from coding trajectories

## Objective

Extract and validate reusable procedures from success/failure Agent trajectories.

## Context files

- `M17 demo traces`
- `M15 evaluation discipline`
...
- Define procedure schema, promotion gates, replay validation, and regression tests.


## Non-goals

- Do not auto-promote unverified LLM summaries.
